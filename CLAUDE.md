...
Invoke with: `use wp-builder` or `@wp-builder build a landing page for...`
...
- **Build pages:** "Build a landing page with a hero, 3 feature cards, and a CTA"
- **Edit content:** "Update the headline on the homepage hero to say..."
- **Manage media:** "Upload this image and set it as the featured image for page 42"
- **SEO:** "Run an SEO audit on the homepage and fix the meta tags"
- **WooCommerce:** "List the 10 best-selling products and update their descriptions"
- **Site info:** "What theme and plugins are active on this site?"
